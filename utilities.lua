...
function removePixel(imageData, x,y)
    imageData:setPixel(x,y,0,0,0,0)
end

function drawPixel(imageData, x,y,color)
    imageData:setPixel(x,y,color.r,color.g,color.b,color.a)
end

function comparePixels(imageData, x,y, x2,y2)
    local r,g,b,a = imageData:getPixel(x,y) 
    local color1 = {r = r,g = g,b = b,a = a} 
    r,g,b,a = imageData:getPixel(x2,y2)
    local color2 = {r = r,g = g,b = b,a = a}
